const resources = {
  en: {
    translation: {
      ...
      個已收藏車站_one: " Bookmarked stop",
      個已收藏車站_other: " Bookmarked stops",
      個到站預報_one: " ETA",
      個到站預報_other: " ETAs",
      匯出網址: "Export URL",
      協助: "Support",
      ...
      切換顏色主題: "Switch color theme",
      主選單: "Main menu",
      提醒通知: "Toggle alert notification",
      車站資訊: "Stop information",
      釘選: "Pin",
      收藏: "Favourite",
      數字鍵盤: "Numeric keypad",
      字母鍵盤: "Alphabet keypad",
      路線輸入鍵盤: "Route input keypad",
      倒退: "Backspace",
      清除: "Clear input",
